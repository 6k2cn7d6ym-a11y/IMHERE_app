...
export default function OrosiChat({ messages, input, setInput, sendMessage, typing, bottomRef, userGu }) {
  const hk = (e) => {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "20px 24px 18px", borderBottom: `1px solid ${C.border}` }}>
        <div style={{ fontFamily: "'Noto Serif KR',serif", fontSize: 22, marginBottom: 5 }}>털어놓기</div>
